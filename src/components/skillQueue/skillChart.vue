...
export default {
  ...
  created() {
    ...
    if (this.testData[0].children.length == 1) {
      ...
      this.testData[0].children[0].width = 50;
      this.testData[0].children[0].height = 50;
      this.testData[0].children[0].dx =
        this.testData[0].children[0].x - this.testData[0].children[0].width;
      this.testData[0].children[0].dy =
        this.testData[0].children[0].y - this.testData[0].children[0].height;
      this.testData[0].children[1].width = 60;
      this.testData[0].children[1].height = 60;
      this.testData[0].children[1].dx =
        this.testData[0].children[1].x - this.testData[0].children[1].width;
      this.testData[0].children[1].dy =
        this.testData[0].children[1].y - this.testData[0].children[1].height;
      this.testData[0].children[1].width = 60;
      this.testData[0].children[1].height = 60;
      this.testData[0].children[1].dx =
        this.testData[0].children[1].x - this.testData[0].children[1].width;
      ...
      this.testData[0].children[2].dx =
        this.testData[0].children[2].x - this.testData[0].children[2].width;
      this.testData[0].children[2].dy =
        this.testData[0].children[2].y - this.testData[0].children[2].height;
      this.testData[0].children[3].width = 60;
      this.testData[0].children[3].height = 60;
      this.testData[0].children[3].dx =
        this.testData[0].children[3].x - this.testData[0].children[3].width;
      this.testData[0].children[3].dy =
        this.testData[0].children[3].y - this.testData[0].children[3].height;
      this.testData[0].children[4].width = 50;
      this.testData[0].children[4].height = 50;
      this.testData[0].children[4].dx =
        this.testData[0].children[4].x - this.testData[0].children[4].width;
      this.testData[0].children[4].dy =
        this.testData[0].children[4].y - this.testData[0].children[4].height;
    }

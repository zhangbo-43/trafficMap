  ...
  <g class="progress">
    <g v-for="(item, index) in d3Data.dataset.nodes.children" :key="index">
      <g class="nodes" v-for="(item1, index1) in item.children" :key="index1">
        ...
        <g>
          <path
            :d="drawPathL(item.x, item.y, item1.x, item1.y)"
            stroke="#a09eff"
            fill="none"
          />
        </g>
        ...
        <g class="node" width="200" height="200">
          ...
          <g>
            <text
              ...
              text-anchor="middle"
              dominant-baseline="middle"
              :x="totalNodeX(item1.x)"
              :y="totalNodeY(item1.y)"
              fill="#fff"
              font="12"
        ...
        >
          ...
          <g>
            ...
            <path d="M740 650 C510 660,550 660,550 700" stroke="#a09eff"
              fill="none" /> -->
            <path
              :d="drawPath(item1.x, item1.y, item2.x, item2.y)"
              stroke="#a09eff"
              fill="none"
            />
          </g>
          ...
          <g>
            <text
              class="pro-num"
               text-anchor="middle"
              dominant-baseline="middle"
              :x="totalNodeX(item2.x)"
              :y="totalNodeY(item2.y)"
              fill="#fff"
              font="12"
          ...
          >
            ...
            <g>
              <path
                :d="drawPath(item2.x, item2.y, item3.x, item3.y)"
                stroke="#a09eff"
                fill="none"
              />
            </g>
            ...
            >
              <image
                ...
                width="16"
                height="16"
                :x="InterfaceImgX(item3.x)"
                :y="InterfaceImgY(item3.y)"
                :href="InterfaceImg"
              ></image>
            </g>
            <g>
            ...
            <g>
              ...
              <image
                ...
                width="16"
                height="16"
                :x="breakOffImgX(item3.x)"
                :y="breakOffImgY(item3.y)"
                :href="breakOffImg"
              ></image>
            </g>
            <image
